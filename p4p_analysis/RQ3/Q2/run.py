#!/usr/bin/env python3
"""
Build hit summary for Q2 by merging three maps:
  - clientEquivalenceMap.*
  - clientExecuteTestEquivalenceMap.*
  - oracleEquivalenceMap.*
...
Usage:
  python3 make_q2_hit_summary.py --in q2_attempts.csv --out q2_hit_summary.csv
"""
...
def main():
    ...
    ap.add_argument("--in", dest="in_path", default="q2_attempts.csv",
                    help="Input CSV path (default: q2_attempts.csv)")
    ap.add_argument("--out", dest="out_path", default="q2_hit_summary.csv",
                    help="Output CSV path (default: q2_hit_summary.csv)")
    args = ap.parse_args()
