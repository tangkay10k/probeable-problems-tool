...
public class PersonService {
	...
	public Person findPersonByEmail(String email) {
		...
		return teacher.orElseThrow(() -> new NoSuchElementException("User with email: " + email + " does not exist!"));
	}
	...
	public Person updateUser(Person user) {
		return user instanceof Student ? studentRepository.save((Student) user) :
