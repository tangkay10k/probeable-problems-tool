...
public class ClientPrompts {
	...
	public static String getClientInitialisationPrompt(ProgramLanguage problemLanguage,
		...
		switch (problemLanguage) {
			...
			default -> throw new RuntimeException("Programming language: " + problemLanguage + " does not exist!");
		}
		return basePrompt.replace("//VAR_LANGUAGE_SPECIFIC_INSTRUCTIONS", specificInstructions);
	}

	public static String clientBasePrompt( String problemStatement, String modelAnswer, String constraints) {
		String basePrompt =
			"""
